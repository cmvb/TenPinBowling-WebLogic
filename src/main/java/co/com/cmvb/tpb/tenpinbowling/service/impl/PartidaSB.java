            ...
            for (RondaDto ronda : mapaPartida.get(jugadorPorRonda)) {
                ...
                if (contValidRonda < 9) {
                    if (ronda.esChuza()) {
                        ...
                        ronda.setPuntajeTotal(sumatoriaPuntajesGlobal + ronda.getPuntajeBrutoTotal() + (rondaSiguiente.esChuza() ? rondaSiguiente.getPuntajeBrutoTotal() + (rondaSiguiente2.esChuza() ? rondaSiguiente2.getPuntajeBrutoTotal() : rondaSiguiente2.getListaPuntajes().get(0) + rondaSiguiente2.getListaPuntajes().get(1)) : rondaSiguiente.getListaPuntajes().get(0) + rondaSiguiente.getListaPuntajes().get(1)));
